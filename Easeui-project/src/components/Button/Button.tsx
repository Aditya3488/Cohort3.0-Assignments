  ...
  `inline-flex items-center cursor-pointer justify-center rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50`,
  {
    variants: {
      variant: {
        ...
        ghost:
          "bg-gray-50 hover:bg-gray-100 text-gray-700 dark:bg-zinc-800 dark:hover:bg-zinc-700 dark:text-zinc-200",
        link: "bg-transparent hover:bg-transparent text-indigo-600 dark:text-indigo-400",
        outline:
          "bg-transparent hover:bg-gray-100 text-gray-700 border border-gray-300 dark:hover:bg-zinc-800 dark:text-zinc-200 dark:border-zinc-600",
      },
      size: {
        default: "px-9 py-3",
        sm: "px-4 py-2",
