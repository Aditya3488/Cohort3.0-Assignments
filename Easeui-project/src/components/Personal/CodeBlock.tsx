...
const CodeBlock = ({ code, language = "tsx" }: CodeBlockProps) => {
  ...
  return (
    <div className="relative">
      ...
      <pre className="bg-gray-50 dark:bg-zinc-900 border border-t-0 border-gray-200 dark:border-zinc-700 p-4 rounded-b-md overflow-x-auto">
        <code className="text-sm text-gray-800 dark:text-zinc-200">{code}</code>
      </pre>
    </div>
  );
};
