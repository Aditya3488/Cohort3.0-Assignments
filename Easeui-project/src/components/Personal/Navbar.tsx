  ...
  return (
    <nav className="h-16 w-full flex items-center justify-between px-8">
      <div className="flex items-center gap-10">
        ...
        <div className="hidden sm:flex items-center bg-transparent rounded-md px-3 py-1.5 shadow-xs shadow-gray-300 dark:shadow-none border border-gray-200 dark:border-zinc-700">
      ...
      <ul className="hidden md:flex items-center gap-6 text-gray-500 dark:text-zinc-400">
        <li
        ...
        <li className="cursor-pointer hover:text-black dark:hover:text-white">About</li>
        <li className="cursor-pointer hover:text-black dark:hover:text-white">Templates</li>
        {mode === "dark" && (
          <li
