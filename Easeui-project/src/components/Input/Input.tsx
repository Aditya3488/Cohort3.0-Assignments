...
const inputVariants = cva(
  "w-full rounded-md focus:outline-none shadow-sm transition-all duration-150 bg-white placeholder:text-gray-400 dark:bg-zinc-900 dark:text-zinc-100 dark:placeholder:text-zinc-500",
  // w-full bg-transparent border-b border-gray-500 pb-2 pt-6 focus:outline-none transition-all
  {
    variants: {
      ...
      tone: {
        default:
          "border-gray-300 dark:border-zinc-600 focus:ring-2 focus:ring-blue-400 focus:border-blue-400",
        error:
      ...
      disabled: {
        true: "bg-gray-100 text-gray-400 dark:bg-zinc-800 dark:text-zinc-500 cursor-not-allowed opacity-80",
      },
    },
    defaultVariants: {
      size: "md",
